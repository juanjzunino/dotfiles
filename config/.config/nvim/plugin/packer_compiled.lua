...
_G.packer_plugins = {
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/Users/juanjozunino/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  ["cmp-path"] = {
    loaded = true,
    path = "/Users/juanjozunino/.local/share/nvim/site/pack/packer/start/cmp-path",
  ...
  ["lsp_signature.nvim"] = {
    loaded = true,
    path = "/Users/juanjozunino/.local/share/nvim/site/pack/packer/start/lsp_signature.nvim",
  ...
  ["markdown-preview.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/juanjozunino/.local/share/nvim/site/pack/packer/opt/markdown-preview.nvim",
  ...
  ["nvim-ts-rainbow"] = {
    loaded = true,
    path = "/Users/juanjozunino/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow",
  ...
  ["vim-solidity"] = {
    loaded = true,
    path = "/Users/juanjozunino/.local/share/nvim/site/pack/packer/start/vim-solidity",
